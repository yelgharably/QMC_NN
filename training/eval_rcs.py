...
def plot_wavefunction_cartesian(x_grid, y_grid, wavefunction_grid, title, filename):
...
def eigen_xyz(model):
    ...
    plot_wavefunction_cartesian(x_grid, y_grid, ground_state_wavefunction_grid, "Ground State Wavefunction", "ground.png")
